...
import com.oseasy.initiate.common.ftp.exceptions.FtpConnectionException;
...
public class VsftpFactory extends BasePoolableObjectFactory {
    ...
    public void passivateObject(Object arg0) throws Exception {
        ...
        positiveCompletion = FTPReply.isPositiveCompletion(reply);
        boolean connected = vsftp.getFtpclient().isConnected();
        if (!connected) {//连接关了 在打开
            vsftp = new Vsftp(host, port, username, passwd);
        }
    }
