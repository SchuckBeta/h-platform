...
import com.oseasy.initiate.modules.actyw.tool.process.vo.SnPropertyPackages;
import com.oseasy.initiate.modules.actyw.tool.process.vo.SnRules;
import com.oseasy.initiate.modules.actyw.tool.process.vo.SnStencils;
...
public class ActYwSten {
  ...
  public static ActYwSten genActYwSten() {
    try {
      return genActYwStens(JsonAliUtils.readJson(RtSvl.RtModelVal.STENCILSET_JSON)).get(0);
    } catch (Exception e) {
      e.printStackTrace();
    }
    return null;
