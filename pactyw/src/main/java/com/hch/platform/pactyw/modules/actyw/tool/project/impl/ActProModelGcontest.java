...
public class ActProModelGcontest implements IActProDeal {
	...
	public static final String ACT_REMARKS = "act大赛流程";
	...
	public Boolean dealMenu(ActProParamVo actProParamVo) {
		...
		if(proProject != null){
			Menu  menu=systemService.getMenu(SysIds.SITE_MENU_GCONTEST_ROOT.getId());
	...
	public Boolean dealCategory(ActProParamVo actProParamVo) {
		...
		categoryapp.setHref("javascript:onGcontestApply('/cms/form/"+proProject.getProjectMark()+"/applyForm','"+actYw.getId()+"');");
