...
public class GprocessStartAdd extends IGnodeOper<ActYwGnode, ActYwEngineImpl, GprocessFlowValidate> implements IGnodeRunner<GnodeVrtpl, Ggroup>{

  public GprocessStartAdd() {
    super();
  }

  public GprocessStartAdd(ActYwEngineImpl engine, GprocessFlowValidate validate) {
    super(engine, validate);
  }

  public GprocessStartAdd(ActYwEngineImpl engine) {
    super(engine);
  }
