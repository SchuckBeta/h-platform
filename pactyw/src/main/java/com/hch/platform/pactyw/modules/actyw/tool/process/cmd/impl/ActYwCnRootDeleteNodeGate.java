 ...
 */
@Service
public class ActYwCnRootDeleteNodeGate extends ActYwAbsEngine<ActYwEngineImpl> implements ActYwCommand<ActYwPgroot>, ActYwCommandCheck<ActYwPgroot>{
  protected static final Logger LOGGER = Logger.getLogger(ActYwCnRootDeleteNodeGate.class);

  public ActYwCnRootDeleteNodeGate() {
    super();
  }

  public ActYwCnRootDeleteNodeGate(ActYwEngineImpl engine) {
    super(engine);
  }
