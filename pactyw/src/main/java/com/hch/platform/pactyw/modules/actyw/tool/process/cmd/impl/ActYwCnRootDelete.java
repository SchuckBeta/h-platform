 ...
 */
@Service
public class ActYwCnRootDelete extends ActYwAbsEngine<ActYwEngineImpl> implements ActYwCommand<ActYwGroup>, ActYwCommandCheck<ActYwGroup>{
  protected static final Logger LOGGER = Logger.getLogger(ActYwCnRootDelete.class);

  public ActYwCnRootDelete() {
    super();
  }

  public ActYwCnRootDelete(ActYwEngineImpl engine) {
    super(engine);
  }
...
//      actYwRgroot.setEndGnode(endGnodeNew);
  ...
  @Override
  public ActYwRstatus<ActYwGnode> initParams(ActYwGroup group) {
    ActYwRstatus<ActYwGnode> rstatus = new ActYwRstatus<ActYwGnode>();
