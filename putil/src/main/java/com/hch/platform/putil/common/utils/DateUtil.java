...
public class DateUtil extends DateUtils {
  ...
  public static final String FMT_YYYY_MM_DD_HHmmss = "yyyyMMddHHmmss";
     ...
     * @return Dtype
     */
    public static Dtype getByNum(String num) {
      if ((num != null)) {
  ...
  public static Integer addDayByType(Dtype type, Integer num, Date date) {
    return addDayByType(type, num, date, false);
  }
   ...
   * @return Integer
   */
  public static Integer addDayByType(Dtype type, Integer num, Date date, Boolean useDef) {
    if((type == null) || (num == null) || (useDef && (date == null))){
      return null;
    }
    ...
    if(useDef){
      ...
      switch (type) {
        case YEAR:
          days = (int) DateUtil.pastDays(date, addYear(date, num));
          break;
        case YEAR_A_HALF:
          days = (int) DateUtil.pastDays(date, addMonth(date, 6 * num));
          break;
        case QUARTER:
          days = (int) DateUtil.pastDays(date, addMonth(date, 3 * num));
          break;
        case MONTH:
          days = (int) DateUtil.pastDays(date, addMonth(date, num));
          break;
        case DAY:
          days = num;
          break;
