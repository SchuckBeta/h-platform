 ...
 */
package com.hch.platform.pcore.modules.dasai.service;
...
import com.hch.platform.pcore.modules.dasai.dao.OaDasaiDao;
...
public class OaDasaiService extends CrudService<OaDasaiDao, OaDasai> {
	...
	public void save(OaDasai oaDasai) {
		...
		ProcessInstance procIns=runtimeService.startProcessInstanceByKey(key, "oa_dasai"+":"+oaDasai.getId(),vars);
