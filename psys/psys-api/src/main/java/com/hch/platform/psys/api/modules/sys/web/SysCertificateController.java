...
import com.hch.platform.pcore.modules.sys.service.SysCertificateService;
...
//    }
		return "redirect:"+Global.getAdminPath()+"/sys/sysCertificate/?repage";
	}
  ...
  public ActYwRstatus<SysCertificate> ajaxCertRes(@PathVariable String id, @RequestParam(required=false) String type, @RequestParam(required=false) Boolean hasUse) {
    ActYwRstatus<SysCertificate> rstatus = new ActYwRstatus<SysCertificate>();
    ...
    rstatus.setDatas(sysCertificate);
    return rstatus;
  }
