                            ...
                            function appendAssignTbody()
                            {
                                ...
                                assignedXhr.success(function (data) {
                                    ...
                                    data.forEach(function (t, i) {
                                        ...
                                        if (teamName) {
                                            trs += '<tr data-index="' + i + '"><td>' + (i + 1) + '</td><td>' + t.name + '</td><td><span class="team-name">' + teamName + " / " + companyName + " / " + proName + '</span></td><td>' + t.data.applicant.name + '</td><td style="display: none">' + t.data.remarks + '</td></tr>'
                                        }
                                    });
