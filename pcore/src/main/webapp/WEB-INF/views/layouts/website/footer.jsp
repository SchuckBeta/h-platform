...
<link rel="stylesheet" type="text/css" href="/common/dialog/dialog.css">
...
<div class="footerBox">
    ...
    <div class="title">导航地图链接</div>
    <div class="frend-links">
        <a href="http://www.moe.gov.cn/" target="_blank">
            <img src="/img/jiaoyubu.png"/>
        </a>
        <a href="http://cy.ncss.org.cn/" target="_blank">
            <img src="/img/cyw.png"/>
        </a>
        <a href="http://www.xuetangx.com/" target="_blank">
            <img src="/img/xuetangzaixian.png"/>
        </a>
        <a href="http://www.chuangqingchun.net/about" target="_blank">
            <img src="/img/chuangqinchun.png"/>
        </a>
        <a href="http://www.lanqiao.org/" target="_blank">
            <img src="/img/lanqiaobei.png"/>
        </a>
        <div class="cl"></div>
    </div>
    <div class="footerline"></div>
    <p class="copyright">Copyright © 2015-2018 武汉噢易云计算股份有限公司</p>
</div>

<div id="notifyModule" class="footer-notify-container">
    <div class="notify-wrap">
        <div class="notify-header clearfix">
            <span>消息<span class="no-readbar">（<span class="no-read-num"></span>条）</span></span>
...
//            }
        ...
        NotifyModule.prototype.updateItem = function (data) {
            ...
            itemHtml.push('<div data-notify-id="'+data.notifyId+'" class="item text-center"><div class="msg-box">' + content + '</div>');
        ...
        NotifyModule.prototype.tplListHtml = function (list) {
            ...
            $.each(list, function (i, item) {
                ...
                html += '<div class="item text-center ' + (i === 0 ? 'active' : '') + '" data-notify-id="' + item.notifyId + '" data-team-id="' + item.teamId + '"> ' +
