        ...
        <div class="contest-content hide">
            ...
            <div class="contest-wrap">
              ...
              <%--  <div class="row">
                ...
                --%>
                <div class="btngroup">
                    <button type="button" id="btnStepOne" class="btn btn-primary-oe go-next">下一步</button>
                    <button type="button" id="saveStepOne" class="hide">保存</button>
                    <button id="goBackStepOne" type="button" class="btn btn-default-oe">返回</button>
                </div>
            </div>
        </div>
    <%--</form:form>
    <form:form id="competitionfmSecond" modelAttribute="proModelMd" action="/f/proprojectmd/proModelMd/save" method="post" class="form-horizontal"
        ...
        <div class="contest-content hide">
            ...
            <div class="contest-wrap">
                ...
                <div class="btngroup">
                    <button type="button" class="btn btn-primary-oe go-prev">上一步</button>
                    <button type="button" class="btn btn-primary-oe go-next">下一步</button>
            ...
            <div class="contest-wrap">
                ...
                <div class="btngroup">
                    ...
                    <div id="btnUpload"
                         ...
                         class="btn btn-primary-oe has-disabled">上传申报资料</div>
                    <button type="button" class="btn btn-primary-oe go-prev">上一步</button>
                    <button  id="saveApplyForm" type="button" class="btn btn-primary-oe"
                            <c:if test="${isSubmit!=null && isSubmit==1}">disabled </c:if>
                        >保存</button>
                    <button id="submitApplyForm" type="button"
                            <c:if test="${isSubmit!=null && isSubmit==1}">disabled </c:if>
                            class="btn btn-primary-oe">提交</button>
                </div>
            </div>
        </div>
...
<script src="/js/md/mdApplyBak.js" type="text/javascript" charset="utf-8"></script>
