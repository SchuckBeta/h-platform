...
<head>
    ...
    <script type="text/javascript">
        ...
        function expData(){
        	$.get('/a/proprojectmd/checkExpApproval?gnodeId='+$("#gnodeId").val()+"&actywId="+$("#actywId").val(), {}, function (data) {
                if(data.ret=="0"){
                	confirmx("没有需要导出的数据，继续导出？",function(){
                		location.href="/a/proprojectmd/expApproval?gnodeId="+$("#gnodeId").val()+"&actywId="+$("#actywId").val();
                	});
                }else{
       				location.href="/a/proprojectmd/expApproval?gnodeId="+$("#gnodeId").val()+"&actywId="+$("#actywId").val();
                }
       	...
       	function impData(){
       		location.href="/a/impdata/mdlist?type=6";
       	}
    </script>
</head>
<body>
