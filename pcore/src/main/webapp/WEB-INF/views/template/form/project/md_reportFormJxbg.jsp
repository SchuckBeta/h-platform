...
<div class="container project-view-contanier">
    ...
    <form:form id="competitionfm" modelAttribute="proModelMd" action="/f/proprojectmd/proModelMd/closeSubmit" method="post" class="form-horizontal"
        ...
        <div class="contest-content">
            ...
            <div class="contest-wrap">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-box">
                               ...
                               <%--<input type="hidden" name="modelId" id="modelId" value="${proModelMd.modelId}"/>--%>
                                <input type="hidden" name="proModel.proCategory" id="proCate" value="${proModelMd.proModel.proCategory}"/>
                ...
                <div class="result-textarea-box">
                    <textarea placeholder="不少于300字" name="result" minLength="300" class="form-control" rows="5"></textarea>
                </div>
                <%--<div class="edit-bar edit-bar-sm clearfix">
                    <div class="edit-bar-left">
                        <span>中期报告附件</span>
                ...
                <div class="btngroup">
                    ...
                    <button type="button" class="btn btn-primary-oe" onclick="closeSubmit(this)">提交</button>
