...
<div class="mybreadcrumbs"><span>课程管理</span></div>
<div class="table-page">
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/course/list">课程列表</a></li>
        <li class="active">
            <a href="${ctx}/course/form?id=${course.id}">
                课程${ not empty course.id ? '修改':'添加'}</a>
        </li>
    </ul>
    <form:form id="inputForm" modelAttribute="course" action="${ctx}/course/save" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div id="uploadCover">
                    ...
                    <ul id="fileListCover" class="filelist">
            ...
            <div class="controls">
                <div class="clearfix">
                    <div id="uploadVideo">
                        ...
                        <ul id="fileVideoList" class="filelist"></ul>
                        <div id="filePickerVideo">
                        </div>
                    </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:textarea path="description" htmlEscape="false" rows="5" maxlength="2000" class="input-xxlarge required"/>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <table id="teacherSearchResult" class="table table-hover">
                    <thead>
                    <tr>
                        <td>姓名</td>
                        <td>学院名</td>
                    ...
                    <c:if test="${not empty course.teacherList}">
                        <c:forEach items="${course.teacherList}" var="teacher">
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-xs btn-danger btn-delete-teacher">删除</button></td>
                            </tr>
                        </c:forEach>
                    </c:if>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:textarea path="courseSummary" htmlEscape="false" rows="5" maxlength="2000" class="input-xxlarge required"/>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div id="uploadLesson" class="upload-lesson">
                    <sys:frontFileUpload fileitems="${course.attachmentList}" filepath="course" btnid="filePickerLesson"></sys:frontFileUpload>
...
<script type="text/javascript" src="/js/course/uploadVideo.js"></script>
<%--<script type="text/javascript" src="/js/course/uploadFujian.js"></script>--%>
<script type="text/javascript">
    $(function () {
        ...
        $.typeahead({
            ...
            hint: true,
            accent: true,
            emptyTemplate: '<table><tr><td  class="text-center">没有结果</td></tr></table>',
            template: '<table><tr><td width="80">{{teacherName}}</td><td>{{collegeName}}</td><td width="80">{{postName}}</td></tr></table>',
            ...
            callback: {
                onLayoutBuiltAfter: function () {
                    if ($('.typeahead__item_head').size() < 1) {
                        $('<li class="typeahead__item typeahead__group-group typeahead__item_head"><div class="typeahead__item_head_box"><table><tr><td width="60">姓名</td><td>学院名</td><td width="80">职位</td></tr></table></div></li>').insertBefore('.typeahead__list>li:first')
                    }
                },
        ...
        function templateTd(result) {
            return ('<tr><td data-id="' + result.teacherId + '">' + result.teacherName + '</td><td>' + result.collegeName + '</td><td>' + result.postName + '</td><td><button type="button" class="btn btn-xs btn-danger btn-delete-teacher">删除</button></td></tr>')
        }
