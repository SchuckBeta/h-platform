...
<div id="lessonIntro" class="container" style="width: 1270px;padding-top: 60px;padding-bottom: 60px;">
    <ol class="breadcrumb breadcrumb-leesson" style="margin-top: 0">
        <li><a href="/f"><i class="icon-home"></i>首页</a></li>
        <li><a href="/f/course/frontCourseList">名师讲堂</a></li>
        <li class="active">名师讲堂详情</li>
    </ol>
    <div class="title-module">
        ...
        <p class="create-time-type">
            ...
            <span class="creat-type">课程类型分类：
                <i> ${fns:getDictLabel(course.type, '0000000078', '')}</i>
            </span>
             <span class="creat-type">状态分类：
    ...
    <div class="row lesson-info-module">
        ...
        <div class="col-md-6">
            ...
            <div class="down-video dropdown">
                <button id="dLabel" type="button" class="btn" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                    下载课件
