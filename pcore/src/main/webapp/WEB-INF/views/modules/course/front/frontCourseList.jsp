...
<div class="container" style="width: 1270px;padding-top: 60px;padding-bottom: 60px;">
    <ol class="breadcrumb" style="margin-top: 0">
        <li>
            <a href="/f/"><i class="icon-home"></i>首页</a>
        </li>
        <li>名师讲堂</li>
    </ol>
    <div class="row">
                        ...
                        <div class="lesson-info">
                            ...
                            <div class="lesson-info-footer clearfix">
                                <div class="create-info">
                                    <span><i class="iconfont">&#xe609;</i>发布于<fmt:formatDate value="${course.publishDate}" pattern="yyyy-MM-dd"/></span>
                                        ...
                                        <ul class="dropdown-menu" >
                                            <c:if test="${not empty course.attachmentList}">
                                                <c:forEach items="${course.attachmentList}" var="attachment">
                                                    <li><a onclick="downLoadCourse('/f/course/downLoad?id=${course.id}&url=${attachment.url}&fileName=${attachment.name}');" href="javascript:void(0);">${attachment.name}</a></li>
                                                </c:forEach>
                                            </c:if>
        ...
        <div class="col-md-4">
            <form:form action="/f/course/frontCourseList" modelAttribute="course" method="post" id="searchForm">
                <input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}" />
                <input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}" />
                <div class="form-search-box">
                    <input type="text" name="name" class="form-control-teacher" placeholder="课程名称或者教师名">
                ...
                <div class="lesson-type">
                    ...
                    <div class="tags">
                        <span><input id="categoryAll" name="categoryAll" type="checkbox" class="check-lesson-type"><label
                                for="categoryAll">全部</label></span>
                        <form:checkboxes path="categoryValueList" items="${fns:getDictList('0000000086')}" class="check-lesson-type"
                                         itemLabel="label"
                                         itemValue="value"/>
                    </div>
                </div>
                <div class="lesson-type">
                    ...
                    <div class="tags">
                        <span><input id="typeAll" name="typeAll" type="checkbox" class="check-lesson-type"><label for="typeAll">全部</label></span>
                        <form:checkboxes path="typeList" items="${fns:getDictList('0000000078')}" itemLabel="label" class="check-lesson-type"
                                         itemValue="value"/>
                    </div>
                </div>
                <div class="lesson-type">
                    ...
                    <div class="tags">
                        ...
                        <form:checkboxes path="statusList" items="${fns:getDictList('0000000082')}" itemLabel="label" class="check-lesson-type"
                                         itemValue="value"/>
                    </div>
                </div>
            </form:form>
