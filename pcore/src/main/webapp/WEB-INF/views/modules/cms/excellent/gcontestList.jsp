        ...
        <form:form id="searchForm" modelAttribute="vo" action="${ctx}/cms/excellent/gcontestList" method="post"
            ...
            <div class="row">
                ...
                <div class="left-form">
                    <div class="form-group">
                        <label for="categoryId">大赛类型</label>
                    ...
                    <div class="form-group">
                        <label for="status">评级</label>
                        <form:select path="level" class="input-medium">
                            <form:option value="" label="--请选择--"/>
                            <form:options items="${fns:getDictList('competition_college_prise')}" itemLabel="label" itemValue="value"
                                          htmlEscape="false"/>
                        </form:select>
                    </div>
                    <div class="form-group">
            ...
            <div class="row">
            	...
            	<shiro:hasPermission name="excellent:projectShow:edit">
                    <input class="btn btn-danger" id="resallbtn" onclick="resall()" style="width: auto;height: auto;background: #e9432d !important" type="button" value="一键发布"/>
            ...
            <c:forEach items="${page.list}" var="es">
                <tr><td><input type="checkbox" name="subck" onclick="subckchange(this)" data-fid="${es.foreignId}" value="${es.id}" ></td>
                    ...
                    <c:if test="${es.state=='0' }">
                    	<a href="${ctx}/cms/excellent/gcontestShowForm?gcontestId=${es.foreignId}" class="btn">审核</a>
                    </c:if>
                    <c:if test="${es.state=='1' }">
                        <a href="${ctx}/cms/excellent/unrelease?ids=${es.id}&from=gcontestList" class="btn">取消发布</a>
                    </c:if>
