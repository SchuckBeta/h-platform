...
<%@ page import="com.oseasy.initiate.modules.sys.entity.User" %>
...
<div class="table-page">
    ...
    <form:form id="inputForm" modelAttribute="site" action="${ctx}/cms/site/save" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            <label class="control-label">学院Logo1:</label>
            <div class="controls">
                ...
                <form:hidden path="logo" htmlEscape="false" maxlength="255" class="input-xlarge"/>
                    ...
                    <%--isshow="true"/>--%>
                <img id="logoImg" src="${(empty site.logo) ? '/images/upload.png' : fns:ftpImgUrl(site.logo)}"
        ...
        <div class="control-group">
            <label class="control-label">学院Logo2:</label>
            <div class="controls">
                ...
                <img id="logoText" src="${empty site.logoSite ? '/images/upload.png' : fns:ftpImgUrl(site.logoSite)}"
    ...
    <sys:upLoadCutImage width="100" height="50" btnid="uploadXX" column="logoSite" imgId="logoText" filepath="temp/site"
                        className="modal-avatar hide" modalId="modalAvatar1" aspectRatio="2"></sys:upLoadCutImage>
    <sys:upLoadCutImage width="100" height="100" btnid="uploadLogo" column="logo" imgId="logoImg" filepath="temp/site"
