				...
				<tr>
					<%-- <td>
						<a href="${ctx}/actyw/actYwForm/form?id=${actYwForm.id}">
							<c:if test="${actYwForm.proType!=null&&actYwForm.proType!=''}">
							${pj:getProProjectName(actYwForm.proType)}
							</c:if>
						</a>
					</td> --%>
					<td>
					...
					<%-- <td>
						<a href="${ctx}/actyw/actYwForm/form?id=${actYwForm.id}">
							<c:if test="${actYwForm.proType!=null&&actYwForm.proType!=''}">
							${fns:getDictLabel(actYwForm.proType, 'act_project_type', '')}
							</c:if>
						</a>
					</td> --%>
					<td>
						...
						<%-- ${fns:getDictLabel(actYwForm.type, 'act_form_type', '')} --%>
					</td>
					<td>
					...
					<td style="text-align: left;">
						${actYwForm.name}&nbsp;&nbsp;&nbsp;&nbsp;${actYwForm.path}
						<br>${actYwForm.listForm.name}&nbsp;&nbsp;&nbsp;&nbsp;${actYwForm.listForm.path}
					</td>
					<td>
						<a href="${ctx}/actyw/actYwForm/form?id=${actYwForm.id}">
