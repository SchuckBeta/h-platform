            ...
            <div class="contest-content">
                ...
                <div class="contest-wrap">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-box">
                            <p style="height: auto">${projectDeclare.introduction}</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><i class="icon-require">*</i>前期调研准备：</label>
                        <div class="input-box">
                            <p style="height: auto">${projectDeclare.innovation}</p>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <table class="table table-bordered table-team task">
                                ...
                                <c:if
                                    ...
                                    <c:forEach items="${projectDeclareVo.plans}" var="item"
                                        ...
                                        <tr>
                                            <td>${status.index+1}</td>
                                            <td>${projectDeclareVo.plans[status.index].content }</td>
                                            <td>${projectDeclareVo.plans[status.index].description }</td>
                                            ...
                                            <td>${projectDeclareVo.plans[status.index].quality }</td>
                                        </tr>
                                    </c:forEach>
                                </c:if>
                                </tbody>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-box">
                            <p style="height: auto;">${projectDeclare.resultContent}</p>
                        </div>
                    </div>
                    <div class="edit-bar edit-bar-sm clearfix">
                        <div class="edit-bar-left">
                    ...
                    <div class="form-group">
                        <p style="padding-left: 65px">${projectDeclare.budget}</p>
                    </div>
                    <div class="edit-bar edit-bar-sm clearfix">
                        <div class="edit-bar-left">
                    ...
                    <sys:frontFileUpload fileitems="${projectDeclareVo.fileInfo}" readonly="true"></sys:frontFileUpload>
                    <div class="edit-bar edit-bar-sm clearfix">
                        <div class="edit-bar-left">
                    ...
                    <div class="form-group">
                        <c:if
                                test="${projectDeclare.status!=null&&projectDeclare.status!='0'}">
