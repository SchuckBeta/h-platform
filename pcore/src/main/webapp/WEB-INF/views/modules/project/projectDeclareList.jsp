                    ...
                    <tr>
                        ...
                        <td style="white-space: nowrap">
                            <c:if test="${projectDeclare.leaderId==user.id}">
                                <c:if test="${projectDeclare.status_code==null||projectDeclare.status_code==0}">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a class="btn btn-primary-oe btn-sm"
                                               href="${ctx}/promodel/proModel/form?id=${projectDeclare.id}">修改</a>
                                        </c:otherwise>
                                    </c:choose>
                            ...
                            <c:if test="${projectDeclare.proc_ins_id!=null&&projectDeclare.proc_ins_id!=''}">
                                <%-- <a class="btn btn-primary-oe btn-sm" href="${ctx}/act/task/processMapByType?proInsId=${projectDeclare.proc_ins_id}&type=gc&status=${projectDeclare.status_code}" target="_blank">跟踪</a> --%>
                                <c:choose>
