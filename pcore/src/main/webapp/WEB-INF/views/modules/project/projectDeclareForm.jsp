...
<head>
    ...
    <style>
        ...
        .ui-widget.ui-widget-content.agree-box {
            height: auto !important;
        }
        .ui-widget.ui-widget-content.jquery-dialog {
            height: auto !important;
        }

        .jquery-dialog .ui-dialog-buttonset{
            padding-bottom: 15px;
        }

        .agree-box .ui-dialog-buttonset {
            padding-bottom: 15px;
        }

        .agree-box .agree-actions {
            text-align: center;
        }
...
<div class="container project-view-contanier" style="padding-top: 0">
    ...
    <form:form id="form1" modelAttribute="projectDeclareVo" action="save" method="post" class="form-horizontal"
        ...
        <div class="contest-content">
            ...
            <div class="contest-wrap">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="user_name" class="control-label"><i class="icon-require">*</i>项目负责人：</label>
                            <div class="input-box">
                                <input type="text" id="user_name" class="form-control" value="${leader.name}" readonly/>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="user_officename" class="control-label"><i class="icon-require">*</i>学院：</label>
                            <div class="input-box">
                                <input type="text" name="user_officename" id="user_officename" class="form-control"
                                       value="${leader.office.name}" readonly/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label"><i
                                    class="icon-require">*</i>专业年级：</label>
                            <div class="input-box">
                                <input type="text" name="user_professional"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-box">
                                <input type="text" name="user_mobile" value="${leader.mobile}"
                                       class="form-control" readonly/>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="input-box">
                                <input type="text" maxlength="128" class="form-control" id="projectDeclareName"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="projectDeclare.source" class="control-label"><i
                                    class="icon-require">*</i>项目来源：</label>
                            <div class="input-box">
                    ...
                    <div class="col-md-12">
                        <div class="form-group form-span-checkbox">
                            <label class="control-label"><i
                                    class="icon-require">*</i>项目拓展及传承：</label>
                ...
                <div class="table-condition">
                    <div class="form-group">
                        ...
                        <div class="input-box" style="max-width: 394px;">
                            <form:select required="required" onchange="GCSB.findTeamPerson();"
                                         path="projectDeclare.teamId"
                ...
                <div class="form-group">
                    <label for="projectDeclare.introduction" class="control-label"><i
                            class="icon-require">*</i>项目介绍：</label>
                    <div class="input-box">
                        <textarea class="form-control" rows="3"
                                  name="projectDeclare.introduction"
                                  maxlength="512">${projectDeclare.introduction}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="projectDeclare.innovation" class="control-label"><i
                            class="icon-require">*</i>前期调研准备：</label>
                    <div class="input-box">
                        <textarea class="form-control" rows="3"
                                  name="projectDeclare.innovation"
                                  maxlength="512">${projectDeclare.innovation}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-box">
                        <table class="table table-bordered table-team yuantb">
                            ...
                            <textarea name="projectDeclare.planContent" class="form-control" rows="3"
                                      maxlength="512">${projectDeclare.planContent}</textarea>
                                </td>
                            ...
                            <textarea name="projectDeclare.planStep" class="form-control" rows="3"
                                      maxlength="512">${projectDeclare.planStep}</textarea>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered table-team task">
                            ...
                            <c:if test="${projectDeclareVo.plans==null||projectDeclareVo.plans.size() ==0}">
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="plans[0].content" maxlength="512" required rows="3"
                                                  class="form-control"></textarea>
                                    </td>
                                    <td>
                                        <textarea name="plans[0].description" maxlength="1024" required rows="3"
                                                  class="form-control"></textarea>
                                    </td>
                                    <td style="vertical-align: middle">
                                        <div class="time-input-inline">
                            ...
                            <c:if test="${projectDeclareVo.plans!=null&&projectDeclareVo.plans.size() >0}">
                                <c:forEach items="${projectDeclareVo.plans}" var="item" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            <textarea required maxlength="512" class="form-control" rows="3"
                                                      name="plans[${status.index}].content">${projectDeclareVo.plans[status.index].content }</textarea>
                                        </td>
                                        <td>
                                            <textarea required maxlength="1024" class="form-control" rows="3"
                ...
                <div class="form-group">
                    <label for="projectDeclare.resultContent" class="control-label"><i
                            class="icon-require">*</i>成果说明：</label>
                    <div class="input-box">
                        <textarea class="form-control" rows="3"
                                  name="projectDeclare.resultContent"
                                  maxlength="512">${projectDeclare.resultContent}</textarea>
                    </div>
                </div>
                <div class="edit-bar edit-bar-sm clearfix">
                    <div class="edit-bar-left">
                ...
                <div class="form-group">
                    <textarea placeholder="简要描述在项目各个阶段产生的费用项目及明细，如：硬件采购、耗材费、差旅费等" maxlength="512" rows="3"
                              class="form-control"
                ...
                <div class="btngroup">
                    ...
                    <button type="button" class="btn btn-primary-oe btn-save">保存
                    </button>
                    <button type="submit" class="btn btn-primary-oe btn-submit">
                        提交并保存
                    </button>
                    <div class="btn-upload-file" style="margin-left: 0" id="btnUpload">上传附件</div>
                </div>
            </div>
        </div>
    </form:form>
...
<div class="dialog-tip" title="信息" style="z-index: 10000">
    <div class="dialog-html" style="text-align: center">
    </div>
</div>
...
<script>
    $(function () {
        ...
        function jqueryDialog(status, msg, buttons) {
            var html;
        ...
        function loginOutState() {
            jqueryDialog(0, "未登录或登录超时。请重新登录，谢谢！", {
                确定: function () {
        ...
        $form.on('click', 'button.btn-save', function (e) {
            ...
            if (!validate1.element('#projectDeclareName')) {
                jqueryDialog(0, '请填写项目名称');
                return false;
            }
            //学分配比的校验
