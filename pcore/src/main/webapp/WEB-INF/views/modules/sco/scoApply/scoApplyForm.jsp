    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#accessories').on('click', 'a', function (e) {
                ...
                if (type == 'pdf') {
                    window.open('/ftp/pagePdfView?url=' + url + '&fileName=' + encodeURI(fileName) + '&ftpUrl=' + ftpUrl);
                }
            })
        ...
        <div class="credit-apply">
            ...
            <ul class="nav nav-block-box">
                <li><span><span style="color: red;margin-right: 4px;">*</span>实际学时：</span>
                    <input type="text" name="realTime" id="realTime" class="form-control input-sm required"  value="${fns:deleteZero(scoApply.realTime)}"/>
                </li>
                <li><span><span style="color: red;margin-right: 4px;">*</span>实际成绩：</span>
                    <input type="text" name="realScore" id="score" class="form-control input-sm required" value="${fns:deleteZero(scoApply.realScore)}">
                    <span>分</span>
                </li>
            </ul>
