...
<div class="container-fluid">
    ...
    <form:form class="form-horizontal" id="inputForm"
        ...
        <div class="control-group">
            <label class="control-label" for="type"><i class="require-star">*</i>学分类型：</label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label" for="item"><i class="require-star">*</i>学分项：</label>
            <div class="controls">
        ...
        <div class="control-group skill" style="display:none">
            <div class="control-group-inline">
                <label class="control-label" for="skill_category"><i class="require-star">*</i>技能证书类型：</label>
                <div class="controls">
        ...
        <div class="control-group project" style="display:none">
            <div class="control-group-inline">
                <label class="control-label" for="project_category"><i class="require-star">*</i>项目类型：</label>
                <div class="controls">
                    <form:select path="project_category" class="form-control required"  onchange="pcChange(this,'category')">
					<form:option value="" label="--请选择--"/>
            ...
            <div class="control-group-inline project_subdivision">
                <label class="control-label" for="project_subdivision"><i class="require-star">*</i>项目类别：</label>
                <div class="controls">
                    <form:select path="project_subdivision" class="form-control required" onchange="setV(this,'subdivision')">
					<form:option value="" label="--请选择--"/>
        ...
        <div class="control-group gcontest" style="display:none">
            <div class="control-group-inline">
                <label class="control-label" for="gcontest_category"><i class="require-star">*</i>大赛类型：</label>
                <div class="controls">
                   <form:select path="gcontest_category" class="form-control required"   onchange="gcChange(this,'category')">
					<form:option value="" label="--请选择--"/>
        ...
        <div class="control-group procId" style="display:none">
         <div class="control-group-inline">
             <label class="control-label" for="procId"><i class="require-star">*</i>学分认定流程：</label>
             <div class="controls">
        ...
        <div class="control-group">
        	<div class="control-group-inline">
				...
				<div class="controls">
					<textarea id="remarks" class="input-xlarge" name="remarks" rows="5" maxlength="255">${scoAffirmConf.remarks}</textarea>
				</div>
			</div>
        </div>
        <div class="control-group">
