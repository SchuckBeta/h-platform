...
<head>
    ...
    <style type="text/css">
        ...
        .form-period-point-box {
            margin-left: 20px;
            margin-right: 20px;
            margin-top: 8px;
        }

        .form-period-point-box:first-child {
            margin-top: 0;
        }
        ...
        .my-error-input {
            border-color: rgba(227, 58, 45, 0.8) !important;
        }
        ...
        .table-credit-setting-container {
            width: 100%;
            overflow-y: hidden;
            overflow-x: auto;
        }

        .table-credit-setting-container a {
...
<div class="container-fluid">
    ...
    <form:form id="inputForm"
        ...
        <div class="table-credit-setting-container">
            <table class="table table-bordered table-credit-setting table-fixed table-align-left table-no-wrap">
                <caption>${cname }</caption>
                <thead>
                <tr>
                    <th width="30%"><i class="require-star">*</i>课时</th>
                    <th width="70%"><i class="require-star">*</i>成绩及学分标准</th>
                </tr>
                </thead>
                <tbody id="dataTb">
                <c:if test="${empty  map}">
                        ...
                        <td>
                            <div class=" form-period-point-box">
                                <div class="pull-right">
                                    ...
                                    <a title="删除成绩及学分标准"  class="hide delete-td" href="javascript:void (0);"><img src="/img/minuse.png">
                                    </a>
                                </div>
                                <div class="text-left">
                                    <div class="form-period-point">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:forEach items="${item.value.scores}" var="score">
                                    <div class=" form-period-point-box">
                                        <div class="pull-right">
                                            <a title="添加成绩及学分标准" class="add-td" href="javascript:void (0);"><img src="/img/plus2.png">
                                            </a>
                                            <a title="删除成绩及学分标准" class="hide delete-td hide" href="javascript:void (0);"><img
                                                    src="/img/minuse.png"> </a>
                                        </div>
                                        <div class="text-left">
                                            <div class="form-period-point">
                                                ...
                                                <span>-</span>
                                                <input name="${fns:getUuid() }" type="text"
                                                       class="form-period ckNumber " value="${score.end }">
                                                <span style="margin-right: 15px;">分</span>
                                                <span>认定</span>
                                                <input name="${fns:getUuid() }" type="text" class="form-period ckScore"
                                                       value="${score.score }">
