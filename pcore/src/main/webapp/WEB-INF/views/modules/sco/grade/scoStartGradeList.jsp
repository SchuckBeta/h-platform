...
<div class="container-fluid">
    ...
    <div class="form-table-row">
        <form id="searchStartForm" class="form-inline" modelAttribute="scoProjectVo" action="/a/sco/scoreGrade/startList">
        ...
        <table class="table table-bordered table-condensed table-hover table-theme-default table-has-sort table-vertical-middle">
            ...
            <c:forEach  items="${page.list}" var="scoProjectVo">
                <tr>
                    ...
                    <td class="none-wrap">
                        <a class="btn-oe btn-primary-oe btn-sm-oe"  onclick="view('/a/sco/scoreGrade/startView?id=${scoProjectVo.scoAffirm.id}')">查看</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
