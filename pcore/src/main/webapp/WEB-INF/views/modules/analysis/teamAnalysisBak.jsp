...
//                    orient: 'vertical',
        ...
        function setProjectTrendsChart(url, params,chart) {
            $.ajax({
                ...
                success : function(data) {
                    ...
                    var options = projectTrendsOption(legendData,categorydata,data,['#9bbb59', '#4bacc6', '#f79646', '#c0504d', '#8064a3']);
        ...
        function setProjectTypeOption(url, params,chart) {
            $.ajax({
                ...
                success : function(data) {
                    ...
                    var options = projectTypeOption(legendData,'', ['#9bbb59', '#4bacc6', '#f79646', '#c0504d', '#8064a3'],categorydata,dataList);
                    chart.setOption(options)
                }
            });
        }
        ...
        $projectDsTps.on('click', function (e) {
            ...
            if(index > 0 && !isLoad){
                ...
                teacherProTypeChart = echarts.init(teacherProTypeCanvas);
