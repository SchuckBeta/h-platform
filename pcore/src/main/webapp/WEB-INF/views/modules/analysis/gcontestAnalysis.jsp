	...
	<div class="view-content">
		<div class="container-fluid">
			...
			<div class="row" style="border: solid #ccc;border-width: 1px 0">
				...
				<p class="text-center seminary-chart-no-data hide" style="height: 500px; line-height: 200px;">没有数据，请重新选择</p>
			</div>
			<div class="row title-bar">
				<div class="col-md-6">
					双创学生参赛统计
			...
			<div class="row" style="border-top: 1px solid #ccc;">
				<div class="col-md-12">
					...
					<p class="text-center stu-chart-no-data hide" style="height: 500px; line-height: 200px;">没有数据，请重新选择</p>
				</div>
			</div>
		</div>
	</div>
