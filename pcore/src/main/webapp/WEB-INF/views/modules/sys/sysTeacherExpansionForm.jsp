...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/sysTeacherExpansion/">导师扩展信息列表</a></li>
		<li class="active"><a href="${ctx}/sys/sysTeacherExpansion/form?id=${sysTeacherExpansion.id}">导师扩展信息<shiro:hasPermission name="sys:sysTeacherExpansion:edit">${not empty sysTeacherExpansion.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:sysTeacherExpansion:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
