                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-box">
                                        <input id="enterdate" name="enterdate" type="text"
                                               maxlength="20"
                                               class="Wdate isTime form-control required"
                                               <%--onclick="WdatePicker({dateFmt:'yyyy',isShowClear:false});"--%>
                                               style="height: 34px;"
                                               readonly="readonly"
                                               value='<fmt:formatDate value="${studentExpansion.enterdate}" pattern="yyyy"/>'
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-box">
                                <form:input type="text" path="user.no" htmlEscape="false"
                                            maxlength="15"
                                            class="form-control userNoForm number"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-4 w317">
    ...
    <div id="dialogContentPhone" class="dialog-content-phone">
        <form id="phoneNumberForm" class="form-horizontal form-dialog">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <button type="button" class="btn pull-right btn-verification getVeri">获取验证码</button>
                </div>
...
<script>
    $(function () {
        ...
        $('#enterdate').on('click', function () {
            ...
            WdatePicker({el: 'enterdate', dateFmt:'yyyy',isShowClear:false, maxDate: graduation || temporaryDate});
        })
    })
