...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/sysTeacherExpansion/">导师扩展信息列表</a></li>
		<shiro:hasPermission name="sys:sysTeacherExpansion:edit"><li><a href="${ctx}/sys/sysTeacherExpansion/form">导师扩展信息添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="sysTeacherExpansion">
			<tr>
				...
				<shiro:hasPermission name="sys:sysTeacherExpansion:edit"><td>
					...
					<a href="${ctx}/sys/sysTeacherExpansion/delete?id=${sysTeacherExpansion.id}" onclick="return confirmx('确认要删除该导师扩展信息吗？', this.href)">删除</a>
