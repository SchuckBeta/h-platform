                    ...
                    <div class="ele-pic-box">
                        <div class="ele-thumbnail">
                            ...
                            <div class="ele-upload-box"
                                 v-upload-file="{data: {url: '/ftp/ueditorUpload/cutImg?folder=sysCertificate/10000&x={{x}}&y={{y}}&width={{width}}&height={{height}}',fileVal: 'upfile', resource: src.resource}, name: 'src',cropOption:cropOption}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="cert-ele-item"
                    ...
                    <div class="ele-pic-box">
                        <div class="ele-thumbnail">
                            ...
                            <div class="ele-upload-box"
                                 v-upload-file="{data: {url: '/ftp/ueditorUpload/cutImg?folder=sysCertificate/10000&x={{x}}&y={{y}}&width={{width}}&height={{height}}',fileVal: 'upfile', resource: water.resource}, name: 'water',cropOption:cropOption}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="cert-ele-item" :class="{'cert-ele-item-select': certEleType === 'backIcon'}"
                    ...
                    <div class="ele-pic-box">
                        <div class="ele-thumbnail">
                            ...
                            <div class="ele-upload-box"
                                 v-upload-file="{data: {url: '/ftp/ueditorUpload/cutImg?folder=sysCertificate/10000&x={{x}}&y={{y}}&width={{width}}&height={{height}}',fileVal: 'upfile', resource: backIcon.resource}, name: 'backIcon',cropOption:cropOption}">
                            </div>
                        </div>
                    </div>
                    <div class="operations">
