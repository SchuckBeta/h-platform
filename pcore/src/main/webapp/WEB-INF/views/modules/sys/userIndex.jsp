        ...
        function getIds(invType) {
            ...
            if (userIds == null || userIds == "" || userIds == undefined) {
                if (userType == 1) {
                    ...
                    if (stuNum > 2) {
                        showModalMessage(0, "最多邀请6个学生！");
                    }
                    showModalMessage(0, "请至少选择一个学生！");
                } else if (userType == 2) {
                    var teaNum = idarray.length;
                    if (teaNum > 2) {
                        showModalMessage(0, "最多邀请2个导师！");
                    }
                    showModalMessage(0, "请至少选择一个导师！");
                } else {

                    showModalMessage(0, "请至少选择一个导师或一个学生！");
                }
                return;
            }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        ...
                        showModalMessage(0, !data.msg ? "操作失败" : data.msg);
                    }
                },
                error: function () {
