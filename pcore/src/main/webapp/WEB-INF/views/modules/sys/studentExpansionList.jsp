...
<div class="container-fluid container-fluid-oe" role="main">
    ...
    <form:form id="searchForm" modelAttribute="studentExpansion" action="${ctx}/sys/studentExpansion/" method="post"
        ...
        <div class="search-form-wrap form-inline">
            ...
            <input id="btnAdd" onclick="create()" class="btn btn-back-oe btn-primaryBack-oe" style="width: auto; height: auto" type="button" value="添加"/>
        ...
        <div class="condition-main form-horizontal">
            <div class="condition-row">
                ...
                <div class="condition-item condition-checkbox" style="width: auto">
                    <div class="control-group">
    ...
    <table id="contentTable" class="table table-hover table-bordered  table-condensed table-theme-default">
        ...
        <tr>
            ...
            <th data-name="u.no"><a class="btn-sort" href="javascript:void(0)"><span>学号</span><i class="icon-sort"></i></a></th>
            <th>姓名</th>
            <th>性别</th>
            <th>当前在研</th>
            <th>现状</th>
        ...
        <c:forEach items="${page.list}" var="studentExpansion">
            <tr>
                ...
                <td style="white-space:nowrap">
                    ...
                    <a href="${ctx}/sys/studentExpansion/delete?id=${studentExpansion.id}" class="btn btn-small"
