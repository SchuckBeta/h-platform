        ...
        <div class="row">
            ...
            <div class="main-content col-md-9" role="main">
                ...
                <div class="text-right">
                    ...
                    <button type="button" class="btn btn-default-oe">取消</button>
                </div>
    ...
    <div id="dialogContentPhone">
        <form id="phoneNumberForm" class="form-horizontal form-dialog">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <button type="button" disabled class="btn pull-right btn-verification getVeri">获取验证码</button>
                </div>
