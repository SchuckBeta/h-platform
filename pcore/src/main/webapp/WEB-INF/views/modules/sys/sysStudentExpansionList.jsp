...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/sysStudentExpansion/">学生扩展信息表列表</a></li>
		<shiro:hasPermission name="sys:sysStudentExpansion:edit"><li><a href="${ctx}/sys/sysStudentExpansion/form">学生扩展信息表添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="sysStudentExpansion">
			<tr>
				...
				<shiro:hasPermission name="sys:sysStudentExpansion:edit"><td>
					...
					<a href="${ctx}/sys/sysStudentExpansion/delete?id=${sysStudentExpansion.id}" onclick="return confirmx('确认要删除该学生扩展信息表吗？', this.href)">删除</a>
