...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/sysStudentExpansion/">学生扩展信息表列表</a></li>
		<li class="active"><a href="${ctx}/sys/sysStudentExpansion/form?id=${sysStudentExpansion.id}">学生扩展信息表<shiro:hasPermission name="sys:sysStudentExpansion:edit">${not empty sysStudentExpansion.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:sysStudentExpansion:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
