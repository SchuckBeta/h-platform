	...
	<div class="container-fluid" style="padding-top:15px;">
		<div class="content-wrap">
			...
			<div class="card">
				...
				<p>
					<strong>版本号：</strong>3.0.0.000
				</p>
				<p>
					<strong>产品状态：</strong><c:if test="${valid=='1'}">已激活</c:if><c:if test="${valid=='0'}">未激活</c:if><c:if test="${valid=='2'}">已过期</c:if>
				</p>
				<p>
					<strong>产品有效期：</strong><c:if test="${valid=='1'||valid=='2'}">${exp}</c:if>
