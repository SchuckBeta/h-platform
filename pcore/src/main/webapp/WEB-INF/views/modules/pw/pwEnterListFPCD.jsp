...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs nav-tabs-default">
        <li class="active"><a href="${ctx}/pw/pwEnter/listFPCD">分配场地列表</a></li>
    </ul>
                    ...
                    <shiro:hasPermission name="pw:pwEnter:edit">
                        <td>
                            <c:if test="${pwEnter.status eq 1}">
                                <a class="btn-primary btn-small btn" href="${ctx}/pw/pwEnterRoom/assignRoomForm?pwEnter.id=${pwEnter.id}">分配场地</a>
                                <%-- <a class="check_btn btn-pray btn-lx-primary" href="${ctx}/pw/pwEnter/form?id=${pwEnter.id}">分配场地</a> --%>
                            </c:if><c:if test="${pwEnter.status ne 1}">
