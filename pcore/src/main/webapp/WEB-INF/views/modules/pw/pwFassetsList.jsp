...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs nav-tabs-default">
        <li class="active"><a href="${ctx}/pw/pwFassets/">固定资产列表</a></li>
    </ul>
    <div class="tab-content-default">
        <form:form id="searchForm" class="form-horizontal clearfix form-search-block" modelAttribute="pwFassets"
            ...
            <div class="col-control-group">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:select path="pwCategory.parent.id" class="input-medium form-control" id="category1" cssStyle="width: 164px;">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:select path="pwCategory.id" class="input-medium form-control" id="category2" cssStyle="width: 164px;">
                            <form:option value="" label="---请选择---"/>
                        </form:select>
                    </div>
                </div>
            ...
            <div class="text-right mgb15">
                <shiro:hasPermission name="pw:pwFassets:edit">
                    <a class="btn btn-primary" href="${ctx}/pw/pwFassets/form">添加资产</a>
                    <a class="btn btn-primary" href="${ctx}/pw/pwFassets/batchForm">批量添加资产</a>
        ...
        <table id="contentTable"
            ...
            <tr>
                ...
                <th width="130" data-name="a.name"><a class="btn-sort" href="javascript:void(0);">资产编号<i class="icon-sort"></i></a>
                </th>
                <th width="90" data-name="c.name"><a class="btn-sort" href="javascript:void(0);">资产名称<i class="icon-sort"></i></a>
                </th>
                <th width="90" data-name="cc.name"><a class="btn-sort" href="javascript:void(0);">资产类别<i class="icon-sort"></i></a>
                </th>
                <th>使用人</th>
                <th>开始使用时间</th>
                <th>使用场地</th>
                <th>联系方式</th>
                <th width="80" data-name="a.status"><a class="btn-sort" href="javascript:void(0);">状态<i class="icon-sort"></i></a>
                </th>
                <shiro:hasPermission name="pw:pwFassets:edit">
                    <th width="260">操作</th>
                </shiro:hasPermission>
                    ...
                    <shiro:hasPermission name="pw:pwFassets:edit">
                        <td>
                            <a class="btn btn-small btn-primary"
                               href="${ctx}/pw/pwFassets/form?id=${pwFassets.id}">修改</a>
                            <c:choose>
                                <c:when test="${pwFassets.status == '0'}">
                                    <a class="btn btn-small btn-primary"
                                       href="${ctx}/pw/pwFassets/assignForm?fassetsIds=${pwFassets.id}">分配</a>
                                    <a class="btn btn-small btn-primary"
