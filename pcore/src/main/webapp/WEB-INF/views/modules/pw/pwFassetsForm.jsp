    ...
    <div class="content_panel">
        ...
        <form:form id="inputForm" modelAttribute="pwFassets" action="${ctx}/pw/pwFassets/save" method="post"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input path="brand" type="text" class="required"/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label"><i>*</i>规格：</label>
                <div class="controls">
                    <form:input path="specification" type="text" class="required"/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label"><i>*</i>购买人：</label>
                <div class="controls">
                    <form:input path="prname" maxlength="20" type="text" class="required"/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label"><i>*</i>手机号码：</label>
                <div class="controls">
                    <form:input path="phone" type="text" class="required phone_number"/>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                <label class="control-label"><i>*</i>价格：</label>
                <div class="controls">
                    <form:input path="price" type="text" class="number input-mini required" maxlength="10"/>
