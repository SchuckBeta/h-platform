...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a
                href="${ctx}/pw/pwSpace/form?id=${pwSpace.id}&parent.id=${pwSpaceparent.id}">校区<shiro:hasPermission
    ...
    <form:form id="inputForm" modelAttribute="pwSpace" action="${ctx}/pw/pwSpace/save" method="post"
        ...
        <div class="control-group">
            <label class="control-label"><i>*</i>校区名称：</label>
            <div class="controls">
                <form:input path="name" id="campus" htmlEscape="false" maxlength="20" class="required"
                            value=""/>
            </div>
        </div>
        <div class="control-group">
