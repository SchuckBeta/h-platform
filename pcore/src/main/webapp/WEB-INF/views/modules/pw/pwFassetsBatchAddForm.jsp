...
<div class="container-fluid">
    ...
    <form:form id="inputForm" modelAttribute="pwFassetsModel" action="${ctx}/pw/pwFassets/batchSave" method="post"
        ...
        <div class="control-group">
            <label class="control-label"><i>*</i>品牌：</label>
            <div class="controls">
                <form:input path="pwFassets.brand" class="required" type="text"/>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label"><i>*</i>规格：</label>
            <div class="controls">
                <form:input path="pwFassets.specification" class="required" type="text"/>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label"><i>*</i>购买人：</label>
            <div class="controls">
                <form:input path="pwFassets.prname" class="required" type="text"/>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label"><i>*</i>联系方式：</label>
            <div class="controls">
                <form:input path="pwFassets.phone" class="required phone" type="text"/>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label"><i>*</i>购买时间：</label>
            <div class="controls">
						<span class="checkbox-inline">
						  <form:input path="pwFassets.time" type="text" class="Wdate required" readonly="true"
                                      onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd' })"/>
						</span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label"><i>*</i>单价：</label>
            <div class="controls">
                <form:input path="pwFassets.price" type="text"
                            class="number input-mini required"  maxlength="10" id="price"/>
                <span class="help-inline">元（人民币）</span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label"><i>*</i>购买数量：</label>
            <div class="controls">
                <form:input path="amount" type="text" class="number digits input-mini required" value="1" maxlength="3"/>
            </div>
        </div>
        <div class="control-group">
    ...
    <div class="modal-body">
        <form id="pwCategoryForm" class="form-horizontal">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="pwFassetsnoRule.prefix" maxlength="3" class="required isLetter"/>
                </div>
            </div>
            <div class="control-group">
