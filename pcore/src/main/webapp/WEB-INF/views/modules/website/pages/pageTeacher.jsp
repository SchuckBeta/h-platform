...
<div class="main-content"  style="padding-top: 60px;">
    ...
    <div class="container" style="width: 1270px;">
        <div class="text-center">
            <div class="title-bar title-bar-show" style="padding-top: 0">
                <h3 style="margin-top: 0">导师风采</h3>
            </div>
        </div>
                            ...
                            <div class="row">
                                    <div class="col-md-3 col-lg-2 col-md-push-9 col-lg-push-10">
                                        ...
                                        <c:choose>
                                             ...
                                             <c:otherwise>
                                                 <img   class="img-responsive" src="/img/u4110.png"  alt="${backTeacherExpansionNew.user.name}">
                                            </c:otherwise>
                                        </c:choose>

                                         <%--  <img class="img-responsive" src="${fns:ftpImgUrl(backTeacherExpansionNew.user.photo) }" alt="${backTeacherExpansionNew.user.name}">--%>
                                        </div>
                                        <p class="name-teacher text-center"><span>${backTeacherExpansionNew.user.name}</span></p>
                                    </div>
                                    <div class="col-md-9 col-lg-10 col-md-pull-3 col-lg-pull-2">
                                        <ul class="info-list info-pill">
                                           <li class="pill"><span>出生日期：
                                              <fmt:formatDate value="${backTeacherExpansionNew.user.birthday}" pattern="yyyy-MM-dd"/>
                                           ...
                                           <li class="pill">学位：${fns:getDictLabel(backTeacherExpansionNew.user.degree, "degree_type", "")}
                                           </li>
                                           <li class="pill">
        ...
        <form:form id="searchForm" modelAttribute="backTeacherExpansion" action="/f/pageTeacher" method="post" class="breadcrumb form-search clearfix" cssStyle="padding: 0">
        ...
        <div class="slider-teacher slider-teacher-school">
            <div class="slider-tc-wrapper">
                <div class="stc-item">
                    <div class="row">
                        <c:forEach var="backTeacherExpansion" items="${page.list}">
                        <div class="col-md-6">
                                    ...
                                    <div class="pic-teacher-box">
                                        ...
                                        <c:choose>
                                            <c:when test="${backTeacherExpansion.user.photo!=null && backTeacherExpansion.user.photo!='' }">
                                               <img   class="img-responsive" src="${fns:ftpImgUrl(backTeacherExpansion.user.photo) }" alt="${backTeacherExpansion.user.name}">
                                            </c:when>
                                            <c:otherwise>
                                               <img   class="img-responsive" src="/img/u4110.png"  alt="${backTeacherExpansion.user.name}">
                                            </c:otherwise>
                                        </c:choose>
