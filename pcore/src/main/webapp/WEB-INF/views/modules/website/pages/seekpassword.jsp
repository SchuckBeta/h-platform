	...
	<body>
		...
		<div class="step1">
			...
			<form id="fmone">
				...
				<p><input id="valicodeyzm" class="fillyanzhengma" name="yanzhengma" type="text" placeholder="请输入验证码" /><small>	<span id="spanyzm"><img src="/servlet/validateCodeServlet" onclick="$('.validateCodeRefresh').click();" class="mid validateCode" style="width:102px;height:40px"></span>
		</small><a id="imgyzm"  class="validateCodeRefresh" onclick="$('.validateCode').attr('src','/servlet/validateCodeServlet?'+new Date().getTime());">换一张</a></p>
