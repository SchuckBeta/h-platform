...
<div class="itemDisplayBox">
    ...
    <div class="text-center">
        <ul class="threeBlock" style="display: inline-block;width: auto">
            ...
            <c:forEach var="porject" items="${excellentShowList.gcontest}">
                <li>
                    ...
                    <div class="project-show-footer">
                            ...
                            src="/img/ll.png"/> ${porject.views} </span> <span class="votedown"><img
                            src="/img/z.png"/> ${porject.likes} </span>
                    </div>
                </li>
            </c:forEach>
        </ul>
...
<!--名师讲堂-->
<div class="text-center">
    <a href="/f/course/frontCourseList">
        <img style="width: auto;display: block;max-width: 100%" src="/img/indexdecopic2_09.png" alt=""/></a>
</div>
        ...
        <ul class="right">
            <c:forEach var="backTeacherExpansion" items="${siteTeacherList}">
                <li>
                    ...
                    <p class="infor">
                        <b class="name"
                           style="float: left; font-size: 18px; color: #342c2a; font-weight: normal">${backTeacherExpansion.user.name}</b>
