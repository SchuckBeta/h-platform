...
<div class="container-fluid container-fluid-oe">
    ...
    <form:form id="searchForm" modelAttribute="act" action="${ctx}/state/closeReplyingList" method="post"
    ...
    <table id="contentTable" class="table table-bordered table-condensed table-hover table-theme-default table-center">
        ...
        <tr>
            ...
            <th style="white-space: nowrap">答辩评分</th>
            <th>项目审核状态</th>
            <th>操作</th>
        </tr>
        </thead>
        ...
        <c:forEach items="${page.list}" var="act">
            <tr>
                ...
                <td>
                    <c:if test="${pj:getById(act.vars.map.id).replyScore>0}">
