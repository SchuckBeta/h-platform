...
<div class="container-fluid container-fluid-oe">
    ...
    <form:form id="searchForm" modelAttribute="act" action="${ctx}/state/closeAuditList" method="post"
    ...
    <table id="contentTable" class="table  table-bordered table-condensed table-hover table-theme-default table-center">
        ...
        <c:forEach items="${page.list}" var="act">
            <tr>
                <td><p class="team-number">${act.status == "other"? act.projectDeclare.number :act.vars.map.number}</p></td>
                <td><p class="team-name">${act.status == "other"? act.projectDeclare.name :act.vars.map.name}</p></td>
                <td>
                ...
                <td>
                        ${pj:getTeamNum(act.status == "other"? act.projectDeclare.snames :act.vars.map.teamList)} <%--${act.vars.map.teamList}--%>
                </td>
                <td>
                ...
                <td style="white-space: nowrap">
                    ...
                    <c:if test="${act.status=='other'}">
                        <a class="btn btn-back-oe btn-primaryBack-oe btn-small" href="${ctx}/state/projectDetail?id=${act.projectDeclare.id}">
                            查看
                        </a>
                    </c:if>
                </td>
