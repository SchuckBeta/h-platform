...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-batch" aria-hidden="true" id="confirmBtn" onclick="doBatch('/f/oa/oaNotify/deleteSendBatch');">确定</button>
...
//                        alert('操作成功');
                        ...
                        showModalMessage(res,'操作成功');
                        window.location.reload()
                    } else if (res = 0 && name == 'accept') {
//                        alert("你已经加入其他团队！");
                        showModalMessage(res,'你已经加入其他团队!');
                        window.location.reload();
                    } else if (res = 4 && name == 'accept') {
//                        alert("该团队已经解散！");
                        showModalMessage(res,'该团队已经解散或你已经加入团队!');
                        window.location.reload();
                    }
                });
