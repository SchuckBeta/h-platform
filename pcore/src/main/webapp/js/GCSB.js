...
+'								</td>'
+'								<td>'
+'									<textarea required name="plans['+GCSB.plansIndex+'].content" class="form-control" rows="3"></textarea>'
+'								</td>'
+'								<td>'
+'									<textarea required name="plans['+GCSB.plansIndex+'].description" class="form-control" rows="3"></textarea>'
+'								</td>'
...
+'								</div></td>'
+'								<td>'
+'									<input  type="text" class="number required form-control" name="plans['+GCSB.plansIndex+'].cost"/>'
+'								</td>'
+'								<td>'
+'									<textarea required class="form-control" rows="3" name="plans['+GCSB.plansIndex+'].quality"></textarea>'
+'								</td>'
+'								<td>'
+'									<a class="minus"></a>'
+'									<a class="plus"></a>'
