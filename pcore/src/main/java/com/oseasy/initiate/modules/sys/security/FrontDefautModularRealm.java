  ...
  protected static final Logger LOGGER = Logger.getLogger(FrontDefautModularRealm.class);
    ...
    private Map<String, Object> definedRealms;
     ...
     protected AuthenticationInfo doAuthenticate(AuthenticationToken authenticationToken)throws AuthenticationException {
        ...
        //判断前台登录类型
         if ("1".equals(token.getLoginType())) {//短信
             realm = (Realm) this.definedRealms.get("frontAuthorizingRealm");
         }else if ("2".equals(token.getLoginType())) {
             realm = (Realm) this.definedRealms.get("frontPasswAuthorizingRealm");
         }
