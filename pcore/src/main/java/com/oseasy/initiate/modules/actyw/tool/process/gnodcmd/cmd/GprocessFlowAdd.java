...
public class GprocessFlowAdd extends IGnodeOper<ActYwGnode, ActYwEngineImpl, GprocessFlowValidate> implements IGnodeRunner<GnodeVrtpl, Ggroup>{

  public GprocessFlowAdd() {
    super();
  }

  public GprocessFlowAdd(ActYwEngineImpl engine, GprocessFlowValidate validate) {
    super(engine, validate);
  }

  public GprocessFlowAdd(ActYwEngineImpl engine) {
    super(engine);
  }
