...
public class SiteController extends BaseController {
	...
	public String save(Site site, Office office, Model model, RedirectAttributes redirectAttributes) {
		...
		if (StringUtil.isNotEmpty(site.getLogo())) {
			 try {
				String moveEnd=FtpUtil.moveFile(FtpUtil.getftpClient(), site.getLogo());
				site.setLogo(moveEnd);
			} catch (IOException e) {
				e.printStackTrace();
			}
		}

		siteService.save(site, office);
