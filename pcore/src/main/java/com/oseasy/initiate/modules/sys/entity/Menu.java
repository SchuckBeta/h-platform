...
public class Menu extends DataEntity<Menu> {
	...
	public long getTodoCount() {
		if(StringUtil.endsWith(this.getHref(),"setAuditList")){
			return ProjectUtils.getAuditListCount();
		}else if(StringUtil.endsWith(this.getHref(),"middleAuditList")){
			return ProjectUtils.getMidCount();
		}else if(StringUtil.endsWith(this.getHref(),"closeAuditList")){
			return ProjectUtils.closeAuditCount();
		}else if(StringUtil.endsWith(this.getHref(),"closeReplyingList")){
			return ProjectUtils.closeReplyingCount();
		}else if(StringUtil.endsWith(this.getHref(),"assessList")){
			return ProjectUtils.assessCount();
		}else if(StringUtil.endsWith(this.getHref(),"collegeExportScore")){
			return GcontestUtils.collegeExportCount();
		}else if(StringUtil.endsWith(this.getHref(),"schoolActAuditList")){
			return GcontestUtils.schoolActAuditList();
		}else if(StringUtil.endsWith(this.getHref(),"schoolEndAuditList")){
