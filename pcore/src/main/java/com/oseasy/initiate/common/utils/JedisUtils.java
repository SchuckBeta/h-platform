...
public class JedisUtils {
	...
	public static List<Object> keys(String cacheKeyName) {
		List<Object> vals = new ArrayList<Object>();
		Jedis jedis = null;
		try {
			jedis = JedisUtils.getResource();
			Collection<byte[]> col = jedis.hkeys(JedisUtils.getBytesKey(cacheKeyName));
			for(byte[] val : col) {
	...
	public static List<Object> values(String cacheKeyName) {
		List<Object> vals = new ArrayList<Object>();
		Jedis jedis = null;
		try {
			jedis = JedisUtils.getResource();
	...
	public static Object getObject(String cacheKeyName,String key) {
		Object value = null;
		Jedis jedis = null;
		try {
			jedis = getResource();
			value=jedis.hget(JedisUtils.getBytesKey(cacheKeyName), JedisUtils.getBytesKey(key));
		} catch (Exception e) {
			logger.warn("getObject {} = {}", key, value, e);
		} finally {
			returnResource(jedis);
...
//			logger.debug("getResource.", jedis);
		...
		logger.debug("JedisUtils.getResource 消费时间："+(System.currentTimeMillis()-start) +"ms");
		return jedis;
	}
