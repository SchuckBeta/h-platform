...
import com.oseasy.initiate.modules.actyw.rest.editor.model.YwModelSaveRestResource;
...
public class JsonAliUtils {
  ...
  public static String readFile(String path) {
    ...
    try {
      ...
      result = FileUtil.readFileToString(file, "UTF-8");
    } catch (IOException e) {
  ...
  public static Boolean writeFile(String path, String content) {
    ...
    try {
      File file = new File(path);
      FileUtil.writeStringToFile(file, content, "UTF-8");
      isTrue = true;
    } catch (IOException e) {
