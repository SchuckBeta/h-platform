 ...
 * @version 2013-8-28
 */
public abstract class AbsBaseInterceptor implements Interceptor, Serializable {
  ...
  private static Logger logger = LoggerFactory.getLogger(AbsBaseInterceptor.class);
