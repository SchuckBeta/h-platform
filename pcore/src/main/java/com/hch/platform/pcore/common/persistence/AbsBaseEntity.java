 ...
 */
@SupTreeList
public abstract class AbsBaseEntity<T> implements Serializable {
  ...
  public AbsBaseEntity(String id) {
    this();
    this.id = id;
  }
  ...
  @JsonIgnore
  @XmlTransient
  public abstract AbsUser getCurrentUser();
  ...
  public boolean equals(Object obj) {
    ...
    AbsBaseEntity<?> that = (AbsBaseEntity<?>) obj;
