...
public abstract class AbsUser extends AbsDataEntity<AbsUser> {
	...
	public AbsUser(String id) {
		super(id);
	}

	public AbsUser(String id, String loginName) {
		super(id);
  ...
  public String getPhoto() {
	...
	public static boolean getAdmin(String id) {
		return (StringUtil.isNotEmpty(id) && (SysIds.SYS_USER_SUPER.getId()).equals(id));
	}
	...
	public static boolean getRsysadmin(String roleId) {
		return StringUtil.isNotEmpty(roleId) && (SysIds.SYS_ROLE_SUPER.getId()).equals(roleId);
	}
	...
	public static boolean getRadmin(String roleId) {
		return (StringUtil.isNotEmpty(roleId) && (SysIds.SYS_ROLE_ADMIN.getId()).equals(roleId));
	}
	 ...
	 * @return
	 */
	public static EuserType getEuserType(AbsUser user) {
		if ((user != null) && StringUtils.isNotEmpty(user.getUserType())) {
			return getEuserType(user.getUserType());
		}
		return null;
	}

	public static EuserType getEuserType(String userType) {
		return EuserType.getByType(userType);
	}
