...
import com.hch.platform.pcore.common.persistence.AbsTreeEntity;
...
public abstract class AbsTreeService<D extends TreeDao<T>, T extends AbsTreeEntity<T>> extends AbsCrudService<D, T> {
